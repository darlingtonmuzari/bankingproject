...
import 'package:bankigproject/Banking/model/BankingModel.dart';
...
import 'package:bankigproject/Banking/utils/BankingDataGenerator.dart';
              ...
              itemBuilder: (BuildContext context, int index) => GestureDetector(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Text(mList1[index].title, style: primaryTextStyle(size: 16))
                        .paddingOnly(
